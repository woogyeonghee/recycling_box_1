import { OCIPullOptions, OciUrl } from './types';
import { CustomError } from '../../../../lib/errors';
export declare const CUSTOM_RULES_TARBALL = "custom-bundle.tar.gz";
export declare function extractURLComponents(OCIRegistryURL: string): OciUrl;
/**
 ...
 **/
export declare function pull({ registryBase, repo, tag }: OciUrl, opt?: OCIPullOptions): Promise<void>;
